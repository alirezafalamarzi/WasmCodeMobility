...
impl host::Host for HostComponent {
    ...
    fn manual_get(&mut self, model: String, prompt: String, context: Vec<u64>) -> Option<String> {
...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    let result1 = functions.call_get_or_fetch(&mut store, "./data.json", "mistral", "What is the first question I asked you?");
